...
# * GAE F4/B4 instances allow for up to 1G of memory to be used.
# * GAE F4_1G/B4_1G instances allow for up to 2G of memory to be used.
...
def post_request(worker, request, environment, response):  # pylint: disable=unused-argument
    ...
    gae_memory = int(os.environ.get('GAE_MEMORY_MB', '1024'))
    memory_threshold_kilobytes = (gae_memory * 1000) / workers  # 1000 megabytes (1000 x 1024) shared between the number of workers
