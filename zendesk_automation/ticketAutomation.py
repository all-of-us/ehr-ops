...
key_file_location = '/Users/em3697/Downloads/aou-ehr-ops-curation-test-4989e7ff9503.json'
...
sheet = service.spreadsheets()
site_contact_result = sheet.values().get(spreadsheetId='1kk_--xyHNI7ohQg3E0VYMyqBWq_CO9iR53RPQpok0Cc',
                            range='Site Contacts').execute()
site_contact_values = site_contact_result.get('values')
site_contact_df = pd.DataFrame(site_contact_values[1:], columns=site_contact_values[0])

# Get Submission Tracking data
submission_tracking_result = sheet.values().get(spreadsheetId='1jn2UHlttx80exkpLpMRIe8MQmHqPnDkIWyrFz8twxSo',
...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="/Users/em3697/.config/gcloud/application_default_credentials.json"
