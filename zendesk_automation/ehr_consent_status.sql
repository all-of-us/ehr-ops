Select participant_id, ORGANIZATION, withdrawal_flag, ehr_consent_yes_flag, mapping.HPO_ID 
from `aou-ehr-ops-curation-prod.ehr_ops_metrics_staging.mv_ehr_rdr_participant` mv_ehr_rdr_participant 
join `aou-ehr-ops-curation-prod.ehr_ops_metrics_staging.mv_org_hpo_mapping` mapping
...
and mapping.HPO_ID in UNNEST(@included_hpos)
