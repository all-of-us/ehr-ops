...
WITH
    visit AS (
        ...
        FROM `{{curation_project}}.{{ehr_ops_dataset}}.unioned_ehr_visit_occurrence` vo
        LEFT JOIN `{{curation_project}}.{{ehr_ops_dataset}}._mapping_visit_occurrence` mvo
...
from
    ...
    FROM `{{curation_project}}.{{ehr_ops_dataset}}.unioned_ehr_condition_occurrence` co
    LEFT JOIN `{{curation_project}}.{{ehr_ops_dataset}}._mapping_condition_occurrence` mco
...
left join
    ...
    FROM `{{curation_project}}.{{ehr_ops_dataset}}.unioned_ehr_procedure_occurrence` po
    LEFT JOIN `{{curation_project}}.{{ehr_ops_dataset}}._mapping_procedure_occurrence` mpo
