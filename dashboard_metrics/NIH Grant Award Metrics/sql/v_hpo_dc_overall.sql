with
    ...
    FROM
       `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_visit_occurrence` AS t1
    JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}._mapping_visit_occurrence` AS mt1
    ...
    FROM
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_condition_occurrence` AS t1
    JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}._mapping_condition_occurrence` AS mt1
    ...
    FROM
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_drug_exposure` AS t1
    JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}._mapping_drug_exposure` AS mt1
    ...
    FROM
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_device_exposure` AS t1
    JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}._mapping_device_exposure` AS mt1
    ...
    FROM
       `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_visit_occurrence` AS t1
    INNER JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_aou_death` AS t2
    ON
    ...
    FROM
       `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_measurement` AS t1
    INNER JOIN
       `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_aou_death` AS t2
        ON
            t1.person_id=t2.person_id
    JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}._mapping_measurement` AS mt1
    ...
    FROM
       `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_procedure_occurrence` AS t1
    INNER JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_aou_death` AS t2
        ON
            t1.person_id=t2.person_id
    JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}._mapping_procedure_occurrence` AS mt1
    ...
    FROM
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_observation` AS t1
    INNER JOIN
         `{{ehr_ops_project}}.{{ehr_ops_dataset}}.unioned_ehr_aou_death` AS t2
        ON
            t1.person_id=t2.person_id
    JOIN
        `{{ehr_ops_project}}.{{ehr_ops_dataset}}._mapping_observation` AS mt1
